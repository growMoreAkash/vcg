            ...
            <div id="strategy" class="tab-content active px-10">
                ...
                <div class="flex flex-col gap-5">
                    <p class="mt-4 text-gray-600 reveal-para">
                        ...
                        A significant number of Mergers & Acquisitions (M&A) and investment deals fail to materialize due to
                        unexpected discrepancies uncovered during the due diligence process.
                    </p>
                    <ul class="grid grid-cols-1 md:grid-cols-2 gap-5 mt-4">
                        @foreach (['These unforeseen risks and inconsistencies often lead to a disconnect between investors and target companies, derailing negotiations and increasing uncertainty.', 'To mitigate these risks and ensure a smooth transaction, engaging a strategic advisor to conduct comprehensive due diligence is not just prudent—it’s essential.'] as $point)
                            <li
                    ...
                    <p class="mt-4 text-gray-600 reveal-para">
                        Vortex Consulting Group: Your Trusted Due Diligence Partner
                    </p>

                    <ul class="grid grid-cols-1 md:grid-cols-2 gap-5 mt-4">
                        @foreach (['At Vortex Consulting Group, we specialize in Commercial & Operational Due Diligence to assist buy-side investors, including those involved in M&A transactions, Private Equity (PE), and Venture Capital (VC) investments.', 'Additionally, we offer sell-side due diligence services to help businesses become prepared sellers, accelerating divestitures and optimizing deal outcomes.', 'Our holistic approach ensures that all risks, opportunities, and deal-critical insights are identified in advance, enabling informed decision-making, smoother negotiations, and higher deal success rates.'] as $point)
                            <li
                                class="strategy-bullet group bg-white border border-gray-100 rounded-2xl p-6 shadow-sm hover:shadow-xl transition-all duration-400 ease-out flex items-start gap-4 cursor-pointer hover:-translate-y-1">
