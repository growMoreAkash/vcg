        ...
        <div class="max-w-7xl mx-auto py-16 px-6">
            ...
            <div id="strategy" class="tab-content active px-10">
                <h1
                    ...
                    Shareholder Value Management </h1>
                <div class="flex flex-col gap-5">
                    <p class="mt-4 text-gray-600 reveal-para">



                        At Vortex Consulting Group, we specialize in enhancing shareholder value by explicitly linking
                        management strategies to the financial returns they generate. Our approach ensures that institutions
                        achieve sustainable growth while maximizing value creation for investors.
                    </p>
                    <p class="mt-4 text-gray-600 reveal-para">
                        Whether it’s optimizing business performance, restructuring for efficiency, or managing strategic
                        carve-outs, our methodologies help organizations unlock their full potential and drive superior
                        financial outcomes.
                    </p>
                    <p class="mt-4 text-gray-600 reveal-para">
                        We assist corporations in navigating complex separations, carve-outs, and spin-offs, ensuring
                        seamless execution and minimal disruption. Our approach ensures that both the parent and the
                        divested entity achieve strategic clarity and financial independence.
                    </p>

                    <ul class="grid grid-cols-1 md:grid-cols-2 gap-5 mt-4">
                        @foreach (['Strategic Assessment: Identify the best approach for separation, whether through divestiture, spin-off, or asset restructuring.', '  Operational Readiness: Ensure smooth transition planning, standalone operations setup, and workforce realignment.', ' Financial Structuring: Optimize capital allocation, balance sheet restructuring, and value realization strategies.', 'Execution Excellence: Provide hands-on support to mitigate risks, accelerate timelines, and maximize stakeholder value.'] as $point)
                            <li
