            ...
            <div id="strategy" class="tab-content active px-10">
                ...
                <div class="flex flex-col gap-5">
                    <p class="mt-4 text-gray-600 reveal-para">
                        If acquiring companies were as straightforward as buying basic commodities, identifying the right
                        targets would be simple.
                    </p>
                    <p class="mt-4 text-gray-600 reveal-para">
                        The distinguishing attributes of each business would be evident, and convincing owners to engage in
                        a transaction would be effortless.
                    </p>
                    <p class="mt-4 text-gray-600 reveal-para">
                        However, in today’s rapidly transforming and disruption-driven marketplace, Mergers & Acquisitions
                        (M&A) require a strategic, methodical approach to successfully identify and secure the right
                        opportunities. A well-structured target screening process, aligned with corporate strategy, is
                        essential for efficient deal execution and long-term portfolio growth.
                    </p>
                    <p class="mt-4 text-gray-600 reveal-para">
                        At Vortex Consulting Group, we specialize in comprehensive target screening and identification,
                        ensuring our clients pinpoint high-value acquisition opportunities that align with their strategic
                        objectives.
                    </p>
                    <p class="mt-4 text-gray-600 reveal-para">
                        Values we Add:
                    ...
                    <p class="mt-4 text-gray-600 reveal-para">
                        Our target screening expertise enables businesses to:
                    </p>
                    <p class="mt-4 text-gray-600 reveal-para">
                        Unlock Untapped Market and Geographic Opportunities
                    </p>

                    <ul class="grid grid-cols-1 gap-5 mt-4">
                        @foreach (['Analyze industry landscapes to identify high-potential market segments for expansion.'] as $point)
                            <li
                    ...
                    <p class="mt-4 text-gray-600 reveal-para">
                        Conduct Rigorous Target Screening
                    </p>

                    <ul class="grid grid-cols-1  gap-5 mt-4">
                        @foreach (['Evaluate and filter relevant market segments, industry trends, and disruptive forces to find the most promising targets.'] as $point)
                            <li
                                class="strategy-bullet group bg-white border border-gray-100 rounded-2xl p-6 shadow-sm hover:shadow-xl transition-all duration-400 ease-out flex items-start gap-4 cursor-pointer hover:-translate-y-1">
                    ...
                    <p class="mt-4 text-gray-600 reveal-para">
                        Align M&A Opportunities with Corporate Strategy
                    </p>

                    <ul class="grid grid-cols-1  gap-5 mt-4">
                        @foreach (['Identify acquisition targets that complement your business objectives, enhance competitive positioning, and maximize value creation.'] as $point)
                            <li
                                class="strategy-bullet group bg-white border border-gray-100 rounded-2xl p-6 shadow-sm hover:shadow-xl transition-all duration-400 ease-out flex items-start gap-4 cursor-pointer hover:-translate-y-1">
                    ...
                    <p class="mt-4 text-gray-600 reveal-para">
                        Facilitate Early-Stage M&A Engagement
                    </p>

                    <ul class="grid grid-cols-1  gap-5 mt-4">
                        @foreach (['Initiate deal introductions and support clients through early-phase negotiations to streamline the acquisition process.'] as $point)
                            <li
                                class="strategy-bullet group bg-white border border-gray-100 rounded-2xl p-6 shadow-sm hover:shadow-xl transition-all duration-400 ease-out flex items-start gap-4 cursor-pointer hover:-translate-y-1">
                    ...
                    <h1 class="mt-4 text-3xl text-gray-600 reveal-para">
                        Our Approach:
                    </h1>

<p class="mt-4 text-gray-600 reveal-para">
Expanded M&A Pipeline                    </p>

                    <ul class="grid grid-cols-1  gap-5 mt-4">
                        @foreach (['Identify a larger pool of high-potential acquisition targets, expanding your deal universe.'] as $point)
                            <li
                                class="strategy-bullet group bg-white border border-gray-100 rounded-2xl p-6 shadow-sm hover:shadow-xl transition-all duration-400 ease-out flex items-start gap-4 cursor-pointer hover:-translate-y-1">
...
<p class="mt-4 text-gray-600 reveal-para">
Unparalleled Market Access                 </p>

                    <ul class="grid grid-cols-1  gap-5 mt-4">
                        @foreach (['Discovering off-market opportunities that may not be on the radar of competitors.'] as $point)
                            <li
                                class="strategy-bullet group bg-white border border-gray-100 rounded-2xl p-6 shadow-sm hover:shadow-xl transition-all duration-400 ease-out flex items-start gap-4 cursor-pointer hover:-translate-y-1">
...
<p class="mt-4 text-gray-600 reveal-para">
Strategic, Impartial Target Selection             </p>

                    <ul class="grid grid-cols-1  gap-5 mt-4">
                        @foreach (['Providing objective, data-driven insights to ensure optimal alignment with your business strategy.'] as $point)
                            <li
                                class="strategy-bullet group bg-white border border-gray-100 rounded-2xl p-6 shadow-sm hover:shadow-xl transition-all duration-400 ease-out flex items-start gap-4 cursor-pointer hover:-translate-y-1">
...
<p class="mt-4 text-gray-600 reveal-para">
Accelerated Deal Execution          </p>

                    <ul class="grid grid-cols-1  gap-5 mt-4">
                        @foreach (['Streamlining the target screening process, saving time and increasing the probability of a successful transaction.'] as $point)
                            <li
                                class="strategy-bullet group bg-white border border-gray-100 rounded-2xl p-6 shadow-sm hover:shadow-xl transition-all duration-400 ease-out flex items-start gap-4 cursor-pointer hover:-translate-y-1">
